...
class Player:
    ...
    def __init__(self, spawn_point):
        """ Конструтор для класса Player, принимает точку возраждения персонажа	spawn_point"""
    ...
    def reset(self):
        """ Метод для сброса атрибутов персонажа	self.health, self.score здоровье и очки"""
    ...
    def shoot(self):
        """ Метод создаёт пулю BulletHandler.Bullet для выстрела и возращяет её как объект """
